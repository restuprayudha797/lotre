    ...
    <body style="background-color:  #18687A">
        ...
        <div class="contact-us">
            <img src="https://hanoilottery-vn.com/img/bg-shape/wp-shape-2.png" alt="" class="wp-bg-shape-2">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-9 col-sm-9 d-xl-flex d-lg-flex d-block align-items-end">
                        <div class="part-img">
                            <img src="https://hanoilottery-vn.com/img/contact/contact-img.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="newsletter">
            <div style="background-color:  #18687A;" class="bg-shape-1">
                <img src="https://hanoilottery-vn.com/img/bg-shape/bg-shape-1.png" alt="">
            </div>
            <img src="https://hanoilottery-vn.com/img/bg-shape/bg-shape-3.png" alt="" class="bg-shape-3">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-8">
                        <div class="part-img">
                            <img src="https://hanoilottery-vn.com/img/newsletter/newsletter-img.png" alt="">
                        </div>
                    </div>
        ...
        <div class="back-to-top-btn">
            <a href="https://hanoilottery-vn.com">
